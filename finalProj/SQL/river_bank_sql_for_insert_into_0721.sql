...
VALUES 
(N'RiverBank', N'台北市大同區環河北路一段113號',562949953421311),
...
VALUES
    ...
    (N'王保全', N'男', N'02-87654321', N'保全公司', N'02-12345678', N'保全公司', NULL, N'啟用', GETDATE(), NULL, N'safe@example.com', 1);-- 保全
...
VALUES
(1, N'大門無法上鎖', N'社區大門自動鎖失效，晚上無法自動上鎖，恐影響住戶安全。', 1200, '已聯絡保全巡檢', 1),
(6, N'停車場照明燈壞掉', N'B2 停車場角落照明燈不亮，導致視線不良。', 600, '待採購燈管', 1),
(21, N'頂樓水塔漏水', N'早上發現頂樓有水漬，疑似水塔底部漏水，需進一步檢查。', 2500, '已請廠商估價', 1),
(18, N'健身房冷氣異常', N'冷氣運轉聲音過大且出風量不足，使用體驗不佳。', 3500, '已安排維修時間', 1),
(19, N'電鈴無聲', N'某戶按門鈴無反應，初判可能為電線接觸不良。', 900, '建議換新電鈴模組', 1),
(10, N'樓梯間滅火器過期', N'住戶發現滅火器有效期限已過，需更換。', 700, '通知消防設備廠商處理', 1),
(15, N'垃圾場異味嚴重', N'垃圾未即時清運，導致味道飄散至一樓大廳。', 0, '加強清潔頻率與通風', 1),
(6, N'車道柵欄無反應', N'地下車道柵欄升降異常，遙控器感應不到。', 2200, '檢查主機與線路', 1);
...
INSERT INTO issue_type_and_ticket (ticket_id, issue_type_id) VALUES
(1, 1),      -- 電梯
(2, 2),      -- 水管
(2, 10),     -- 牆面滲水
(3, 3),      -- 水電
...
INSERT INTO ticket_comment (ticket_id, commenter_id, comment) VALUES
(1, 2, N'我們家住三樓，電梯卡住真的很困擾，請盡快處理！'),
(1, 4, N'剛剛又聽到奇怪聲音，拜託今天先停用電梯，太危險了。'),
(2, 3, N'廚房地板一直積水，走過去很滑，怕家人跌倒。'),
(2, 1, N'已經滲水好幾天了，希望這次能根治問題。'),
(3, 5, N'監視器沒畫面真的很不安心，希望快點修好。'),
(4, 2, N'地下室味道超重，快受不了了，拜託儘快處理。'),
(5, 1, N'大門晚上沒鎖好很沒安全感，拜託今天就修好。'),
(6, 4, N'照明太暗，每次停車都很不方便，希望改善。'),
(7, 3, N'樓上漏水滴到陽台，衣服都濕了，請快處理。'),
(8, 2, N'健身房冷氣好悶熱，根本待不住，拜託儘快維修！');
...
DECLARE @endOfLastMonth DATETIME = DATEADD(
    SECOND, -1,
    CAST(DATEFROMPARTS(YEAR(GETDATE()), MONTH(GETDATE()), 1) AS DATETIME)
);

DECLARE @startOfMonth DATETIME = CAST(DATEFROMPARTS(YEAR(GETDATE()), MONTH(GETDATE()), 1) AS DATETIME);

-- 插入資料
INSERT INTO point_accounts (community_id, unit_id, total_balance, expired_at, updated_at)
VALUES
(1, 1, 200, @endOfMonth, GETDATE()),
...
VALUES
(1, 1, 2, 10, '2025-07-24 19:00:00', '2025-07-24 20:00:00', 0, 50, 50, @endOfLastMonth, N'健身教學', 'APPROVED', @endOfLastMonth),
(1, 1, 3, 28, '2025-07-24 19:00:00', '2025-07-24 20:00:00', 0, 280, 280, @endOfLastMonth, N'舉辦游泳比賽', 'APPROVED', @endOfLastMonth),
(1, 1, 2, 2, '2025-07-23 14:00:00', '2025-07-23 15:00:00', 0, 10, 0, @endOfMonth, N'運動健身', 'CANCELLED', GETDATE()),
(1, 1, 1, 3, '2025-07-19 11:00:00', '2025-07-19 12:00:00', 0, 15, 15, @endOfMonth, N'家庭聚會', 'APPROVED', GETDATE()),
(1, 4, 4, 5, '2025-07-23 09:00:00', '2025-07-23 10:00:00', 0, 10, 10, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
(1, 4, 4, 3, '2025-08-05 18:00:00', '2025-08-05 19:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
...
(1, 5, 4, 3, '2025-08-04 14:00:00', '2025-08-04 15:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
...
(1, 6, 6, 3, '2025-07-22 17:00:00', '2025-07-22 18:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 3, 1, '2025-07-27 18:00:00', '2025-07-27 19:00:00', 0, 10, 10, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 8, 6, 1, '2025-08-04 17:00:00', '2025-08-04 18:00:00', 0, 30, 30, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 3, 4, 1, '2025-08-02 17:00:00', '2025-08-02 18:00:00', 0, 10, 0, @endOfMonth, N'家庭練習', 'CANCELLED', GETDATE()),
(1, 3, 4, 5, '2025-07-19 10:00:00', '2025-07-19 11:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 4, 4, 2, '2025-08-05 12:00:00', '2025-08-05 13:00:00', 0, 10, 0, @endOfMonth, N'團體活動', 'CANCELLED', GETDATE()),
(1, 4, 6, 1, '2025-07-31 14:00:00', '2025-07-31 15:00:00', 0, 30, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 5, 2, 1, '2025-07-27 19:00:00', '2025-07-27 20:00:00', 0, 5, 5, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
(1, 4, 3, 19, '2025-07-17 18:00:00', '2025-07-17 19:00:00', 0, 10, 10, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
(1, 6, 1, 2, '2025-07-17 17:00:00', '2025-07-17 18:00:00', 0, 15, 15, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
...
(1, 7, 4, 5, '2025-07-29 12:00:00', '2025-07-29 13:00:00', 0, 10, 0, @endOfMonth, N'家庭練習', 'CANCELLED', GETDATE()),
...
(1, 8, 2, 4, '2025-07-24 09:00:00', '2025-07-24 10:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 6, 4, '2025-08-01 16:00:00', '2025-08-01 17:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 1, 1, '2025-07-17 18:00:00', '2025-07-17 19:00:00', 0, 15, 15, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
...
(1, 5, 6, 3, '2025-07-30 13:00:00', '2025-07-30 14:00:00', 0, 30, 30, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 3, 1, 1, '2025-07-18 14:00:00', '2025-07-18 15:00:00', 0, 15, 15, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 6, 4, 1, '2025-07-24 18:00:00', '2025-07-24 19:00:00', 0, 10, 10, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
...
(1, 7, 3, 8, '2025-07-18 13:00:00', '2025-07-18 14:00:00', 0, 10, 10, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 8, 3, 30, '2025-07-24 12:00:00', '2025-07-24 13:00:00', 0, 10, 10, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
...
(1, 3, 1, 2, '2025-07-24 12:00:00', '2025-07-24 13:00:00', 0, 15, 0, @endOfMonth, N'朋友聚會', 'CANCELLED', GETDATE()),
(1, 4, 3, 21, '2025-07-25 11:00:00', '2025-07-25 12:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
...
(1, 5, 1, 2, '2025-07-18 12:00:00', '2025-07-18 13:00:00', 0, 15, 15, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 6, 2, 2, '2025-07-22 14:00:00', '2025-07-22 15:00:00', 0, 5, 5, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 7, 2, 2, '2025-08-03 19:00:00', '2025-08-03 20:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 6, 2, '2025-07-23 19:00:00', '2025-07-23 20:00:00', 0, 30, 30, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
(1, 3, 3, 24, '2025-08-05 15:00:00', '2025-08-05 16:00:00', 0, 10, 10, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
(1, 3, 1, 4, '2025-08-01 14:00:00', '2025-08-01 15:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 4, 1, '2025-07-17 10:00:00', '2025-07-17 11:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
...
(1, 5, 1, 4, '2025-07-18 14:00:00', '2025-07-18 15:00:00', 0, 15, 15, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 6, 6, 2, '2025-08-02 11:00:00', '2025-08-02 12:00:00', 0, 30, 30, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
(1, 7, 1, 3, '2025-07-27 10:00:00', '2025-07-27 11:00:00', 0, 15, 15, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 8, 2, 2, '2025-08-05 11:00:00', '2025-08-05 12:00:00', 0, 5, 5, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
(1, 3, 3, 4, '2025-08-04 14:00:00', '2025-08-04 15:00:00', 0, 10, 0, @endOfMonth, N'家庭練習', 'CANCELLED', GETDATE()),
(1, 4, 1, 3, '2025-08-05 14:00:00', '2025-08-05 15:00:00', 0, 15, 0, @endOfMonth, N'團體活動', 'CANCELLED', GETDATE()),
(1, 5, 1, 1, '2025-08-01 09:00:00', '2025-08-01 10:00:00', 0, 15, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
...
(1, 6, 3, 13, '2025-07-29 18:00:00', '2025-07-29 19:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 1, 1, '2025-08-03 09:00:00', '2025-08-03 10:00:00', 0, 15, 15, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
...
(1, 8, 3, 20, '2025-07-27 15:00:00', '2025-07-27 16:00:00', 0, 10, 10, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
(1, 3, 3, 9, '2025-07-27 09:00:00', '2025-07-27 10:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
(1, 4, 3, 13, '2025-07-22 13:00:00', '2025-07-22 14:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
(1, 5, 6, 1, '2025-07-25 18:00:00', '2025-07-25 19:00:00', 0, 30, 30, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
...
(1, 6, 1, 1, '2025-07-17 15:00:00', '2025-07-17 16:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 4, 1, '2025-07-25 10:00:00', '2025-07-25 11:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 1, 1, '2025-08-03 16:00:00', '2025-08-03 17:00:00', 0, 15, 0, @endOfMonth, N'朋友聚會', 'CANCELLED', GETDATE()),
(1, 3, 6, 4, '2025-07-23 16:00:00', '2025-07-23 17:00:00', 0, 30, 30, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 3, 4, 4, '2025-08-05 17:00:00', '2025-08-05 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 3, 7, '2025-07-17 17:00:00', '2025-07-17 18:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
...
(1, 5, 1, 5, '2025-08-01 10:00:00', '2025-08-01 11:00:00', 0, 15, 0, @endOfMonth, N'朋友聚會', 'CANCELLED', GETDATE()),
(1, 6, 6, 4, '2025-07-31 12:00:00', '2025-07-31 13:00:00', 0, 30, 30, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 7, 1, 4, '2025-07-30 15:00:00', '2025-07-30 16:00:00', 0, 15, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 8, 1, 2, '2025-08-01 10:00:00', '2025-08-01 11:00:00', 0, 15, 15, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
(1, 3, 3, 15, '2025-07-21 12:00:00', '2025-07-21 13:00:00', 0, 10, 10, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 4, 4, 3, '2025-07-25 14:00:00', '2025-07-25 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 2, '2025-07-30 13:00:00', '2025-07-30 14:00:00', 0, 5, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 5, 2, 1, '2025-07-18 13:00:00', '2025-07-18 14:00:00', 0, 5, 0, @endOfMonth, N'朋友聚會', 'CANCELLED', GETDATE()),
(1, 6, 3, 15, '2025-07-26 19:00:00', '2025-07-26 20:00:00', 0, 10, 0, @endOfMonth, N'朋友聚會', 'CANCELLED', GETDATE()),
(1, 7, 6, 3, '2025-07-19 15:00:00', '2025-07-19 16:00:00', 0, 30, 30, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
...
(1, 8, 3, 13, '2025-07-19 09:00:00', '2025-07-19 10:00:00', 0, 10, 10, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
(1, 3, 4, 3, '2025-08-01 17:00:00', '2025-08-01 18:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
(1, 4, 1, 4, '2025-07-30 14:00:00', '2025-07-30 15:00:00', 0, 15, 0, @endOfMonth, N'團體活動', 'CANCELLED', GETDATE()),
(1, 5, 2, 3, '2025-07-17 09:00:00', '2025-07-17 10:00:00', 0, 5, 5, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
...
(1, 6, 4, 1, '2025-07-24 09:00:00', '2025-07-24 10:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
...
(1, 7, 4, 4, '2025-07-24 10:00:00', '2025-07-24 11:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
(1, 8, 6, 1, '2025-08-04 16:00:00', '2025-08-04 17:00:00', 0, 30, 30, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
(1, 3, 4, 2, '2025-07-27 15:00:00', '2025-07-27 16:00:00', 0, 10, 0, @endOfMonth, N'團體活動', 'CANCELLED', GETDATE()),
(1, 4, 4, 1, '2025-08-05 10:00:00', '2025-08-05 11:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 3, 21, '2025-07-23 11:00:00', '2025-07-23 12:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
...
(1, 5, 3, 4, '2025-07-21 17:00:00', '2025-07-21 18:00:00', 0, 10, 10, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 6, 1, 2, '2025-07-29 19:00:00', '2025-07-29 20:00:00', 0, 15, 0, @endOfMonth, N'團體活動', 'CANCELLED', GETDATE()),
...
(1, 7, 2, 1, '2025-07-17 12:00:00', '2025-07-17 13:00:00', 0, 5, 0, @endOfMonth, N'家庭練習', 'CANCELLED', GETDATE()),
...
(1, 8, 2, 2, '2025-07-18 18:00:00', '2025-07-18 19:00:00', 0, 5, 5, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
(1, 3, 4, 5, '2025-07-19 12:00:00', '2025-07-19 13:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
...
(1, 4, 2, 5, '2025-07-21 18:00:00', '2025-07-21 19:00:00', 0, 5, 5, @endOfMonth, N'朋友聚會', 'APPROVED', GETDATE()),
(1, 4, 4, 4, '2025-07-24 18:00:00', '2025-07-24 19:00:00', 0, 10, 0, @endOfMonth, N'團體活動', 'CANCELLED', GETDATE()),
(1, 5, 2, 5, '2025-07-30 16:00:00', '2025-07-30 17:00:00', 0, 5, 5, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
(1, 6, 4, 2, '2025-07-31 19:00:00', '2025-07-31 20:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
(1, 7, 1, 4, '2025-07-20 19:00:00', '2025-07-20 20:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 1, 1, '2025-07-22 09:00:00', '2025-07-22 10:00:00', 0, 15, 15, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
(1, 3, 3, 29, '2025-07-28 18:00:00', '2025-07-28 19:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 1, 4, '2025-07-19 11:00:00', '2025-07-19 12:00:00', 0, 15, 15, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
(1, 4, 4, 1, '2025-07-22 17:00:00', '2025-07-22 18:00:00', 0, 10, 10, @endOfMonth, N'家庭練習', 'APPROVED', GETDATE()),
...
(1, 5, 4, 1, '2025-07-19 11:00:00', '2025-07-19 12:00:00', 0, 10, 10, @endOfMonth, N'團體活動', 'APPROVED', GETDATE()),
...
(1, 6, 8, 5, '2025-07-29 16:00:00', '2025-07-29 17:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 4, 6, 1, '2025-07-26 11:00:00', '2025-07-26 12:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 6, 3, '2025-08-01 19:00:00', '2025-08-01 20:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 5, 2, '2025-08-02 17:00:00', '2025-08-02 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 6, 4, '2025-07-31 20:00:00', '2025-07-31 21:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 2, 4, '2025-07-30 11:00:00', '2025-07-30 12:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 4, 3, '2025-08-05 16:00:00', '2025-08-05 17:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 8, 6, 1, '2025-08-06 10:00:00', '2025-08-06 11:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 4, 5, '2025-07-28 13:00:00', '2025-07-28 14:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 1, 3, '2025-08-06 18:00:00', '2025-08-06 19:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 4, 2, '2025-08-06 14:00:00', '2025-08-06 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 2, 3, '2025-08-06 09:00:00', '2025-08-06 10:00:00', 0, 5, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 5, 5, 1, '2025-07-24 14:00:00', '2025-07-24 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 6, 6, 4, '2025-07-25 13:00:00', '2025-07-25 14:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 1, '2025-07-28 13:00:00', '2025-07-28 14:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 4, 2, '2025-07-27 18:00:00', '2025-07-27 19:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 5, 5, '2025-07-25 10:00:00', '2025-07-25 11:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 7, 1, '2025-07-28 11:00:00', '2025-07-28 12:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 4, 4, '2025-07-28 10:00:00', '2025-07-28 11:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 5, 3, '2025-08-07 20:00:00', '2025-08-07 21:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 4, 2, '2025-07-30 14:00:00', '2025-07-30 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 2, '2025-07-28 13:00:00', '2025-07-28 14:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 8, 5, '2025-08-02 13:00:00', '2025-08-02 14:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 2, 4, '2025-07-30 16:00:00', '2025-07-30 17:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 3, 4, '2025-07-29 10:00:00', '2025-07-29 11:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 6, 6, 3, '2025-07-26 09:00:00', '2025-07-26 10:00:00', 0, 30, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 7, 2, 3, '2025-07-27 17:00:00', '2025-07-27 18:00:00', 0, 5, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 5, 5, '2025-07-29 17:00:00', '2025-07-29 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 1, 4, '2025-07-23 18:00:00', '2025-07-23 19:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 3, 4, '2025-07-29 11:00:00', '2025-07-29 12:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 6, 5, '2025-07-25 20:00:00', '2025-07-25 21:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 5, 2, '2025-08-06 09:00:00', '2025-08-06 10:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 7, 1, '2025-07-24 17:00:00', '2025-07-24 18:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 4, 6, 1, '2025-07-24 09:00:00', '2025-07-24 10:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 3, 4, '2025-07-27 18:00:00', '2025-07-27 19:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 7, 2, '2025-07-24 16:00:00', '2025-07-24 17:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 6, 6, 1, '2025-08-07 09:00:00', '2025-08-07 10:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 8, 2, '2025-07-26 18:00:00', '2025-07-26 19:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 7, 7, 4, '2025-07-26 13:00:00', '2025-07-26 14:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 8, 8, 1, '2025-07-26 13:00:00', '2025-07-26 14:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 6, 4, '2025-07-27 13:00:00', '2025-07-27 14:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 7, 2, '2025-08-01 20:00:00', '2025-08-01 21:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 7, 3, '2025-07-31 17:00:00', '2025-07-31 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 6, 7, 2, '2025-07-25 14:00:00', '2025-07-25 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 1, 5, '2025-08-03 16:00:00', '2025-08-03 17:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 1, 3, '2025-08-02 18:00:00', '2025-08-02 19:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 5, '2025-08-06 18:00:00', '2025-08-06 19:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 6, 5, '2025-08-04 16:00:00', '2025-08-04 17:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 6, 4, '2025-07-24 09:00:00', '2025-07-24 10:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 7, 5, '2025-08-04 11:00:00', '2025-08-04 12:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 8, 5, '2025-08-07 09:00:00', '2025-08-07 10:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 3, 1, '2025-07-30 13:00:00', '2025-07-30 14:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 5, 4, '2025-08-06 19:00:00', '2025-08-06 20:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 7, 2, '2025-07-30 18:00:00', '2025-07-30 19:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 6, 1, 4, '2025-07-27 16:00:00', '2025-07-27 17:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 7, 4, '2025-08-01 20:00:00', '2025-08-01 21:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 7, 3, '2025-07-30 18:00:00', '2025-07-30 19:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 2, 4, '2025-08-03 16:00:00', '2025-08-03 17:00:00', 0, 5, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 1, 1, '2025-07-29 17:00:00', '2025-07-29 18:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 4, 5, '2025-08-06 10:00:00', '2025-08-06 11:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 5, 5, '2025-08-02 17:00:00', '2025-08-02 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 7, 5, '2025-07-28 09:00:00', '2025-07-28 10:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 1, 5, '2025-07-30 19:00:00', '2025-07-30 20:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 5, '2025-08-05 20:00:00', '2025-08-05 21:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 5, 3, '2025-07-30 16:00:00', '2025-07-30 17:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 7, 2, '2025-07-27 17:00:00', '2025-07-27 18:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 5, 4, '2025-08-01 16:00:00', '2025-08-01 17:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 4, 5, '2025-07-24 11:00:00', '2025-07-24 12:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 8, 3, '2025-08-07 20:00:00', '2025-08-07 21:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 4, 6, 3, '2025-07-30 10:00:00', '2025-07-30 11:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 8, 3, '2025-08-03 18:00:00', '2025-08-03 19:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 2, 2, '2025-08-01 14:00:00', '2025-08-01 15:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 6, 7, 2, '2025-07-23 11:00:00', '2025-07-23 12:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 8, 3, '2025-07-26 16:00:00', '2025-07-26 17:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 2, 5, '2025-07-27 18:00:00', '2025-07-27 19:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 8, 2, '2025-07-25 14:00:00', '2025-07-25 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 1, '2025-08-04 09:00:00', '2025-08-04 10:00:00', 0, 5, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 1, 5, '2025-08-03 16:00:00', '2025-08-03 17:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 3, 1, '2025-07-30 18:00:00', '2025-07-30 19:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 1, 1, '2025-08-01 19:00:00', '2025-08-01 20:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 5, 5, '2025-08-01 17:00:00', '2025-08-01 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 6, 2, '2025-07-30 10:00:00', '2025-07-30 11:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 2, 1, '2025-07-29 09:00:00', '2025-07-29 10:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 7, 1, '2025-07-30 16:00:00', '2025-07-30 17:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 2, '2025-07-23 14:00:00', '2025-07-23 15:00:00', 0, 5, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 6, 5, 2, '2025-07-26 11:00:00', '2025-07-26 12:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 7, 3, '2025-07-30 09:00:00', '2025-07-30 10:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 2, 5, '2025-07-24 14:00:00', '2025-07-24 15:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 2, 4, '2025-07-31 20:00:00', '2025-07-31 21:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 7, 2, '2025-07-25 19:00:00', '2025-07-25 20:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 5, 1, '2025-08-05 20:00:00', '2025-08-05 21:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 4, 4, '2025-07-26 10:00:00', '2025-07-26 11:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 6, 1, 2, '2025-08-06 18:00:00', '2025-08-06 19:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 5, 3, '2025-08-01 13:00:00', '2025-08-01 14:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 7, 3, '2025-08-06 14:00:00', '2025-08-06 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 1, '2025-07-29 13:00:00', '2025-07-29 14:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 3, 5, '2025-08-06 09:00:00', '2025-08-06 10:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 4, 3, 5, '2025-07-23 10:00:00', '2025-07-23 11:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 7, 4, '2025-08-07 16:00:00', '2025-08-07 17:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 1, 3, '2025-07-30 20:00:00', '2025-07-30 21:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 1, 1, '2025-07-24 18:00:00', '2025-07-24 19:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 2, 4, '2025-07-26 09:00:00', '2025-07-26 10:00:00', 0, 5, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 3, 1, '2025-07-24 17:00:00', '2025-07-24 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 7, 4, '2025-07-31 11:00:00', '2025-07-31 12:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 5, 1, '2025-08-06 16:00:00', '2025-08-06 17:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 3, 4, '2025-08-01 19:00:00', '2025-08-01 20:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 7, 5, '2025-08-01 17:00:00', '2025-08-01 18:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 8, 4, '2025-08-01 13:00:00', '2025-08-01 14:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 1, 3, '2025-07-27 11:00:00', '2025-07-27 12:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 6, 3, 1, '2025-08-05 15:00:00', '2025-08-05 16:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 2, 1, '2025-08-03 15:00:00', '2025-08-03 16:00:00', 0, 5, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 1, 5, '2025-08-01 16:00:00', '2025-08-01 17:00:00', 0, 15, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 3, 5, '2025-08-05 14:00:00', '2025-08-05 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 3, 5, '2025-08-06 10:00:00', '2025-08-06 11:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 4, 8, 2, '2025-07-30 13:00:00', '2025-07-30 14:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 7, 2, '2025-08-04 14:00:00', '2025-08-04 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 1, 4, '2025-08-07 18:00:00', '2025-08-07 19:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 5, 2, '2025-07-26 11:00:00', '2025-07-26 12:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 1, 2, '2025-08-01 14:00:00', '2025-08-01 15:00:00', 0, 15, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 6, 1, '2025-07-31 20:00:00', '2025-07-31 21:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 5, '2025-07-25 10:00:00', '2025-07-25 11:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 4, 2, '2025-07-24 17:00:00', '2025-07-24 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 5, 2, '2025-07-27 13:00:00', '2025-07-27 14:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 5, 1, '2025-08-01 13:00:00', '2025-08-01 14:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 8, 5, '2025-08-06 18:00:00', '2025-08-06 19:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 6, 1, 2, '2025-08-04 19:00:00', '2025-08-04 20:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 6, 1, '2025-08-02 18:00:00', '2025-08-02 19:00:00', 0, 30, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 5, 2, '2025-08-05 17:00:00', '2025-08-05 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 1, 5, '2025-07-26 11:00:00', '2025-07-26 12:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 4, 3, '2025-08-06 19:00:00', '2025-08-06 20:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 8, 5, 4, '2025-07-24 14:00:00', '2025-07-24 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 6, 4, '2025-07-27 16:00:00', '2025-07-27 17:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 5, 1, '2025-08-03 20:00:00', '2025-08-03 21:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 6, 4, '2025-07-24 18:00:00', '2025-07-24 19:00:00', 0, 30, 30, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 6, 4, 3, '2025-08-07 09:00:00', '2025-08-07 10:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 6, 5, '2025-08-02 20:00:00', '2025-08-02 21:00:00', 0, 30, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 7, 8, 2, '2025-07-31 15:00:00', '2025-07-31 16:00:00', 0, 10, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 8, 4, 3, '2025-07-25 17:00:00', '2025-07-25 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 7, 2, '2025-08-01 09:00:00', '2025-08-01 10:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 4, '2025-07-29 17:00:00', '2025-07-29 18:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 1, 4, '2025-07-30 14:00:00', '2025-07-30 15:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 7, 5, '2025-07-25 11:00:00', '2025-07-25 12:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 5, 5, 1, '2025-07-28 16:00:00', '2025-07-28 17:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 6, 4, 2, '2025-07-28 10:00:00', '2025-07-28 11:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 2, 1, '2025-08-01 13:00:00', '2025-08-01 14:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 3, 5, 4, '2025-07-25 17:00:00', '2025-07-25 18:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 2, 4, '2025-07-28 13:00:00', '2025-07-28 14:00:00', 0, 5, 5, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 4, 1, 3, '2025-08-04 09:00:00', '2025-08-04 10:00:00', 0, 15, 15, @endOfMonth, N'', 'APPROVED', GETDATE()),
(1, 7, 6, 5, '2025-07-24 11:00:00', '2025-07-24 12:00:00', 0, 30, 0, @endOfMonth, N'', 'CANCELLED', GETDATE()),
(1, 3, 8, 2, '2025-07-23 14:00:00', '2025-07-23 15:00:00', 0, 10, 10, @endOfMonth, N'', 'APPROVED', GETDATE());
...
VALUES
(1, 1, 'EXPIRED', -65, NULL, NULL, N'系統過期65點', @endOfLastMonth),
(1, 1, 'RESERVATION', -280, NULL, 23, N'陳志明 reservation 游泳池', @endOfLastMonth),
(1, 1, 'RESERVATION', -50, NULL, 23, N'陳志明 reservation 健身房', @endOfLastMonth),
(1, 1, 'SYSTEM', +200, NULL, NULL, N'系統派發100點', @startOfMonth),
(1, 1, 'TEST', +100, NULL, NULL, N'test派發100點', @startOfMonth),
(1, 1, 'CANCEL', +10, NULL, 23, N'陳志明 CANCEL 健身房', GETDATE()),
(1, 1, 'RESERVATION', -10, NULL, 23, N'陳志明 reservation 健身房', GETDATE()),
(1, 1, 'RESERVATION', -15, NULL, 23, N'陳志明 reservation 交誼廳', GETDATE()),
(1, 2, 'EXPIRED', -20, NULL, NULL, N'系統過期20點', @endOfLastMonth),
(1, 2, 'SYSTEM', +100, NULL, NULL, N'系統派發100點', @startOfMonth),
(1, 3, 'EXPIRED', -65, NULL, NULL, N'系統過期65點', @endOfLastMonth),
(1, 3, 'SYSTEM', +100, NULL, NULL, N'系統派發100點', @startOfMonth),
(1, 4, 'EXPIRED', -65, NULL, NULL, N'系統過期65點', @endOfLastMonth),
(1, 4, 'SYSTEM', +100, NULL, NULL, N'系統派發100點', @startOfMonth),
(1, 5, 'EXPIRED', -65, NULL, NULL, N'系統過期65點', @endOfLastMonth),
(1, 5, 'SYSTEM', +100, NULL, NULL, N'系統派發100點', @startOfMonth),
(1, 6, 'EXPIRED', -65, NULL, NULL, N'系統過期65點', @endOfLastMonth),
(1, 6, 'SYSTEM', +100, NULL, NULL, N'系統派發100點', @startOfMonth),
(1, 3, 'CANCEL', +5, NULL, 1, N'林慧如 cancel 健身房', GETDATE()),
...
(1, 3, 'RESERVATION', -10, NULL, 5, N'陳志明 reservation 桌球室B101', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 6, N'張嘉豪 reservation 桌球室B101', GETDATE()),
(1, 3, 'RESERVATION', -5, NULL, 7, N'張嘉豪 reservation 健身房', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 8, N'陳志明 reservation 桌球室B101', GETDATE()),
...
(1, 3, 'RESERVATION', -30, NULL, 16, N'林慧如 reservation 撞球室', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 17, N'林慧如 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -30, NULL, 18, N'林慧如 reservation 撞球室', GETDATE()),
(1, 3, 'CANCEL', +10, NULL, 19, N'張嘉豪 cancel 桌球室B101', GETDATE()),
(1, 3, 'CANCEL', +10, NULL, 20, N'陳志明 cancel 桌球室B101', GETDATE()),
(1, 3, 'CANCEL', +10, NULL, 21, N'林慧如 cancel 桌球室B101', GETDATE()),
(1, 4, 'CANCEL', +30, NULL, 22, N'黃怡君 cancel 撞球室', GETDATE()),
(1, 3, 'RESERVATION', -5, NULL, 23, N'陳志明 reservation 健身房', GETDATE()),
(1, 4, 'RESERVATION', -10, NULL, 24, N'黃怡君 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 25, N'陳志明 reservation 交誼廳', GETDATE()),
(1, 4, 'RESERVATION', -30, NULL, 26, N'黃怡君 reservation 撞球室', GETDATE()),
(1, 4, 'RESERVATION', -5, NULL, 27, N'黃怡君 reservation 健身房', GETDATE()),
(1, 3, 'CANCEL', +10, NULL, 28, N'陳志明 cancel 桌球室B101', GETDATE()),
(1, 4, 'RESERVATION', -10, NULL, 29, N'黃怡君 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -5, NULL, 30, N'張嘉豪 reservation 健身房', GETDATE()),
(1, 3, 'RESERVATION', -5, NULL, 31, N'林慧如 reservation 健身房', GETDATE()),
(1, 4, 'RESERVATION', -30, NULL, 32, N'黃怡君 reservation 撞球室', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 33, N'陳志明 reservation 交誼廳', GETDATE()),
...
(1, 3, 'RESERVATION', -30, NULL, 37, N'林慧如 reservation 撞球室', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 38, N'張嘉豪 reservation 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 39, N'林慧如 reservation 桌球室B101', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 40, N'張嘉豪 reservation 交誼廳', GETDATE()),
(1, 3, 'CANCEL', +5, NULL, 41, N'張嘉豪 cancel 健身房', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 42, N'林慧如 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 43, N'陳志明 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 44, N'張嘉豪 reservation 桌球室B101', GETDATE()),
(1, 4, 'RESERVATION', -5, NULL, 45, N'黃怡君 reservation 健身房', GETDATE()),
(1, 3, 'CANCEL', +15, NULL, 46, N'林慧如 cancel 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 47, N'林慧如 reservation 游泳池', GETDATE()),
...
(1, 3, 'RESERVATION', -15, NULL, 51, N'林慧如 reservation 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -5, NULL, 52, N'陳志明 reservation 健身房', GETDATE()),
(1, 3, 'RESERVATION', -5, NULL, 53, N'陳志明 reservation 健身房', GETDATE()),
(1, 3, 'RESERVATION', -30, NULL, 54, N'林慧如 reservation 撞球室', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 55, N'張嘉豪 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 56, N'林慧如 reservation 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 57, N'林慧如 reservation 桌球室B101', GETDATE()),
...
(1, 3, 'RESERVATION', -15, NULL, 61, N'林慧如 reservation 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -30, NULL, 62, N'陳志明 reservation 撞球室', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 63, N'陳志明 reservation 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -5, NULL, 64, N'林慧如 reservation 健身房', GETDATE()),
(1, 3, 'CANCEL', +10, NULL, 65, N'陳志明 cancel 游泳池', GETDATE()),
(1, 3, 'CANCEL', +15, NULL, 66, N'陳志明 cancel 交誼廳', GETDATE()),
(1, 3, 'CANCEL', +15, NULL, 67, N'陳志明 cancel 交誼廳', GETDATE()),
...
(1, 3, 'RESERVATION', -10, NULL, 71, N'林慧如 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 72, N'陳志明 reservation 交誼廳', GETDATE()),
(1, 3, 'CANCEL', +10, NULL, 73, N'張嘉豪 cancel 桌球室B101', GETDATE()),
(1, 4, 'RESERVATION', -30, NULL, 74, N'黃怡君 reservation 撞球室', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 75, N'林慧如 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 76, N'林慧如 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 77, N'林慧如 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -30, NULL, 78, N'林慧如 reservation 撞球室', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 79, N'張嘉豪 reservation 桌球室B101', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 80, N'張嘉豪 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 81, N'林慧如 reservation 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 82, N'林慧如 reservation 桌球室B101', GETDATE()),
(1, 3, 'CANCEL', +15, NULL, 83, N'陳志明 cancel 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -30, NULL, 84, N'張嘉豪 reservation 撞球室', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 85, N'陳志明 reservation 桌球室B101', GETDATE()),
(1, 3, 'CANCEL', +10, NULL, 86, N'陳志明 cancel 游泳池', GETDATE()),
...
(1, 3, 'CANCEL', +15, NULL, 90, N'林慧如 cancel 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -30, NULL, 91, N'陳志明 reservation 撞球室', GETDATE()),
(1, 3, 'CANCEL', +15, NULL, 92, N'林慧如 cancel 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 93, N'林慧如 reservation 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 94, N'陳志明 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 95, N'陳志明 reservation 桌球室B101', GETDATE()),
(1, 3, 'CANCEL', +5, NULL, 96, N'張嘉豪 cancel 健身房', GETDATE()),
(1, 3, 'CANCEL', +5, NULL, 97, N'陳志明 cancel 健身房', GETDATE()),
(1, 3, 'CANCEL', +10, NULL, 98, N'陳志明 cancel 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -30, NULL, 99, N'林慧如 reservation 撞球室', GETDATE()),
(1, 4, 'CANCEL', +10, NULL, 100, N'黃怡君 cancel 游泳池', GETDATE()),
(1, 3, 'CANCEL', +5, NULL, 101, N'張嘉豪 cancel 健身房', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 102, N'陳志明 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 103, N'陳志明 reservation 桌球室B101', GETDATE()),
(1, 4, 'CANCEL', +15, NULL, 104, N'黃怡君 cancel 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -5, NULL, 105, N'林慧如 reservation 健身房', GETDATE()),
...
(1, 3, 'RESERVATION', -10, NULL, 109, N'陳志明 reservation 桌球室B101', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 110, N'張嘉豪 reservation 交誼廳', GETDATE()),
(1, 4, 'RESERVATION', -30, NULL, 111, N'黃怡君 reservation 撞球室', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 112, N'林慧如 reservation 桌球室B101', GETDATE()),
(1, 3, 'RESERVATION', -30, NULL, 113, N'林慧如 reservation 撞球室', GETDATE()),
(1, 3, 'CANCEL', +10, NULL, 114, N'陳志明 cancel 桌球室B101', GETDATE()),
(1, 4, 'RESERVATION', -10, NULL, 115, N'黃怡君 reservation 桌球室B101', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 116, N'林慧如 reservation 游泳池', GETDATE()),
...
(1, 3, 'RESERVATION', -10, NULL, 123, N'陳志明 reservation 游泳池', GETDATE()),
(1, 3, 'CANCEL', +15, NULL, 124, N'林慧如 cancel 交誼廳', GETDATE()),
(1, 4, 'RESERVATION', -5, NULL, 125, N'黃怡君 reservation 健身房', GETDATE()),
(1, 4, 'RESERVATION', -10, NULL, 126, N'黃怡君 reservation 桌球室B101', GETDATE()),
(1, 3, 'CANCEL', +5, NULL, 127, N'陳志明 cancel 健身房', GETDATE()),
...
(1, 3, 'RESERVATION', -5, NULL, 131, N'陳志明 reservation 健身房', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 132, N'林慧如 reservation 桌球室B101', GETDATE()),
...
(1, 3, 'RESERVATION', -5, NULL, 136, N'林慧如 reservation 健身房', GETDATE()),
(1, 4, 'CANCEL', +10, NULL, 137, N'黃怡君 cancel 桌球室B101', GETDATE()),
(1, 3, 'RESERVATION', -5, NULL, 138, N'陳志明 reservation 健身房', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 139, N'林慧如 reservation 桌球室B101', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 140, N'陳志明 reservation 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 141, N'林慧如 reservation 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 142, N'陳志明 reservation 游泳池', GETDATE()),
(1, 3, 'RESERVATION', -15, NULL, 143, N'張嘉豪 reservation 交誼廳', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 144, N'林慧如 reservation 桌球室B101', GETDATE()),
(1, 3, 'CANCEL', +10, NULL, 145, N'張嘉豪 cancel 桌球室B101', GETDATE()),
(1, 4, 'RESERVATION', -5, NULL, 146, N'黃怡君 reservation 健身房', GETDATE()),
(1, 3, 'RESERVATION', -10, NULL, 147, N'陳志明 reservation 桌球室B101', GETDATE()),
...
(1, 3, 'TRANSFER_OUT', -43, 3, NULL, N'林慧如 轉出給 張嘉豪', GETDATE()),
(1, 3, 'TRANSFER_IN', 43, 2, NULL, N'張嘉豪 收到來自 林慧如', GETDATE()),
(1, 3, 'TRANSFER_OUT', -13, 1, NULL, N'林慧如 轉出給 陳志明', GETDATE()),
(1, 3, 'TRANSFER_IN', 13, 2, NULL, N'陳志明 收到來自 林慧如', GETDATE()),
(1, 3, 'TRANSFER_OUT', -42, 4, NULL, N'張嘉豪 轉出給 黃怡君', GETDATE()),
(1, 4, 'TRANSFER_IN', 42, 3, NULL, N'黃怡君 收到來自 張嘉豪', GETDATE()),
(1, 3, 'TRANSFER_OUT', -41, 3, NULL, N'陳志明 轉出給 張嘉豪', GETDATE()),
(1, 3, 'TRANSFER_IN', 41, 1, NULL, N'張嘉豪 收到來自 陳志明', GETDATE()),
(1, 4, 'TRANSFER_OUT', -38, 2, NULL, N'黃怡君 轉出給 林慧如', GETDATE()),
(1, 3, 'TRANSFER_IN', 38, 4, NULL, N'林慧如 收到來自 黃怡君', GETDATE()),
(1, 3, 'TRANSFER_OUT', -59, 1, NULL, N'林慧如 轉出給 陳志明', GETDATE()),
(1, 3, 'TRANSFER_IN', 59, 2, NULL, N'陳志明 收到來自 林慧如', GETDATE()),
(1, 4, 'TRANSFER_OUT', -16, 1, NULL, N'黃怡君 轉出給 陳志明', GETDATE()),
(1, 3, 'TRANSFER_IN', 16, 4, NULL, N'陳志明 收到來自 黃怡君', GETDATE()),
(1, 3, 'TRANSFER_OUT', -32, 2, NULL, N'張嘉豪 轉出給 林慧如', GETDATE()),
(1, 3, 'TRANSFER_IN', 32, 3, NULL, N'林慧如 收到來自 張嘉豪', GETDATE()),
(1, 4, 'TRANSFER_OUT', -47, 2, NULL, N'黃怡君 轉出給 林慧如', GETDATE()),
(1, 3, 'TRANSFER_IN', 47, 4, NULL, N'林慧如 收到來自 黃怡君', GETDATE()),
...
(N'地下室感應燈壞了', N'晚間回家時整個地下停車場都很暗，感應燈沒有啟動。', 1, 1, 2, N'確認中', '2025-06-13 10:00:00', '2025-06-11 10:00:00', NULL, NULL, 1),
(N'大廳地板有積水', N'最近下雨後大廳靠窗位置常出現積水，容易滑倒。', 2, 2, 3, N'已結案', '2025-06-12 10:00:00', '2025-06-11 10:00:00', NULL, 5, 1),
(N'管理員服務不佳', N'昨日下午詢問事情時，值班人員態度不耐煩，建議加強教育訓練。', 3, 3, 4, N'處理中', '2025-06-14 10:00:00', '2025-06-14 10:00:00', NULL, NULL, 1),
(N'機車停車格不足', N'近期有許多新住戶，機車格不足導致常有亂停情形。', 4, 4, 1, N'已結案', '2025-06-15 10:00:00', '2025-06-12 10:00:00', NULL, 5, 1),
(N'希望加裝戶外遮雨棚', N'希望在管理室外空地設置遮雨棚，讓等待訪客或外送不會淋雨。', 5, 1, 2, N'待處理', '2025-06-15 10:00:00', '2025-06-13 10:00:00', NULL, NULL, 1);
GO
...
( N'本週三社區將進行停水作業', N'由於管線檢修，將於 6/12(三) 上午9點至下午3點暫停供水，請提前儲水備用。', 1, 1, 0, '2025-06-11 10:00:00', '2025-06-12 10:00:00', '2026-06-13 10:00:00', 1, 1),
( N'中庭週末舉辦社區野餐活動', N'本週六下午4點起於中庭舉辦住戶野餐，歡迎全家參加，現場備有小點與飲品。', 2, 2, 1, '2025-06-13 10:00:00', '2025-06-14 10:00:00', '2026-06-16 10:00:00', 1, 1),
( N'B棟電梯維修通知', N'B棟南側電梯將於 6/15~6/17 進行維修保養，請改搭北側電梯，造成不便敬請見諒。', 3, 3, 0, '2025-06-12 10:00:00', '2025-06-14 10:00:00', '2026-06-17 10:00:00', 1, 1),
( N'新住戶報到須知', N'提醒近期搬入的新住戶，請至管理室登記並領取門禁卡及垃圾分類手冊。', 4, 4, 0, '2025-06-10 10:00:00', '2025-06-11 10:00:00', '2026-06-15 10:00:00', 1, 1),
( N'健身房將汰換新設備', N'下週一健身房將更換跑步機與啞鈴設備，期間暫停開放一天，敬請見諒。', 5, 1, 1, '2025-06-15 10:00:00', '2025-06-16 10:00:00', '2026-06-19 10:00:00', 1, 1);
GO
...
(1, N'您是否備妥停水所需水量？', '2025-06-10 10:00:00', '2026-06-16 10:00:00', 0),
(2, N'您是否會參加社區野餐活動？', '2025-06-11 10:00:00', '2026-06-17 10:00:00', 0),
