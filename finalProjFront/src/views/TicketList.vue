  ...
  <div class="ticket-list-view container mt-4">
    ...
    <div class="d-flex align-items-center mb-3">
      ...
      <div class="d-flex align-items-center me-auto">
        ...
        <!-- 放大鏡圖示 -->
        <img src="@/assets/images/ticket/2989907.png" alt="搜尋" style="width: 20px; height: 20px; cursor: pointer;"
          @click="toggleSearch" />
      </div>
    ...
    <div v-if="showSearch" class="mb-3 d-flex align-items-center">
      <input v-model="searchText" type="text" class="form-control me-2" placeholder="輸入關鍵字搜尋..."
        @keyup.enter="applySearch" />

      <!-- 篩選按鈕 -->
      <img src="@/assets/images/ticket/setting.png" alt="篩選" style="width: 24px; height: 24px; cursor: pointer;"
        @click="toggleFilter" />
    </div>
