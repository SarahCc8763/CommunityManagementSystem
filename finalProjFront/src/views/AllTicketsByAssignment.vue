<template>
  <div class="container py-4">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3 position-relative ">
          ...
          <div class="custom-multiselect" @click.stop="toggleDropdown">
            ...
            <!-- Dropdown 清單 -->
            <ul v-if="showDropdown" class="dropdown-list bg-dark text-light" @click.stop>
    ...
    <ul class="nav nav-tabs mb-4" role="tablist">
      <li class="nav-item">
        <a class="nav-link" :class="{ active: selectedTab === 'unassigned' }" href="#"
          @click.prevent="selectedTab = 'unassigned'">❌ 未指派報修單</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" :class="{ active: selectedTab === 'assigned' }" href="#"
          @click.prevent="selectedTab = 'assigned'">✅ 已指派報修單</a>
      </li>
    </ul>
        ...
        <div v-if="assignedTickets.length">
          <div class="d-flex">
            ...
            <div class="flex-grow-1">
              <div v-for="ticket in paginatedAssignedTickets" :key="ticket.id"
                class="card mb-3 p-3 shadow-sm bg-dark text-light" @click="openDetail(ticket)">
            ...
            <ul class="pagination flex-column ms-3">
              <li class="page-item" v-for="page in assignedTotalPages" :key="page"
                :class="{ active: assignedPage === page }" @click="assignedPage = page" style="cursor: pointer">
    ...
    <AssignedTicketDetail v-if="showDetailModal" :key="selectedTicket.id" :ticket="selectedTicket"
      :vendor-list="vendors" @close="showDetailModal = false" @update-ticket="updateTicket" />
    ...
    <div v-if="selectedTab === 'unassigned'">
      ...
      <div v-if="paginatedUnassignedTickets.length">
        <div class="d-flex">
          ...
          <!-- 右側分頁 -->
          <ul class="pagination flex-column ms-3">
            <li class="page-item" v-for="page in unassignedTotalPages" :key="'unassigned-' + page"
              :class="{ active: unassignedPage === page }" @click="unassignedPage = page" style="cursor: pointer">
              <a class="page-link">{{ page }}</a>
            </li>
          </ul>
        </div>
