          ...
          <ul class="menu-list">
            <li v-for="(item, idx) in menuItems" :key="idx" class="menu-item">
              ...
              <div v-if="item.children" class="menu-group">
                <div
                  class="menu-header"
                  :class="{ 'menu-header-active': openIdx === idx }"
                  @click="toggle(idx)"
                >
                  <router-link
                    :to="item.link || '#'"
              ...
              <router-link
                v-else
                :to="item.link"
                class="menu-link menu-link-single"
              >
                {{ item.label }}
              </router-link>
            </li>
...
<style scoped>
  ...
  @media (max-width: 1200px) {
    .user-name, .user-username, .user-badge {
      font-size: 12px;
    }
  }
  ...
  @media (max-width: 480px) {
    ...
    .user-username, .user-badge, .placeholder-subtitle {
      font-size: 10px;
    }
    .quick-actions-row {
      gap: 4px;
    ...
    .logout-button, .placeholder-login-btn {
      font-size: 11px;
      padding: 7px 8px;
      border-radius: 8px;
      margin-top: 6px;
