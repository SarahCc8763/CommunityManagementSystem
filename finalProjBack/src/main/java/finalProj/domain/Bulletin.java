...
//    private BulletinCategory category;
	...
	@OneToOne(mappedBy = "bulletin", cascade = CascadeType.ALL)
...
//    }
	...
	public String toString() {
		return "Bulletin [id=" + id + ", title=" + title + ", description=" + description + ", user=" + user
				+ ", isPinned=" + isPinned + ", postTime=" + postTime + ", modifyTime=" + modifyTime + ", removeTime="
				+ removeTime + ", postStatus=" + postStatus + "]";
	}
